   ...
   <table>
      <tr>
         ...
         <td rowspan="2" colspan="3">
            ...
            <?php echo htmlspecialchars($result['address'] ?? '', ENT_QUOTES, 'UTF-8'); ?><br>
            <strong>GSTIN :</strong> <?php echo htmlspecialchars($result['gstin'] ?? '', ENT_QUOTES, 'UTF-8'); ?>6<br>
            <strong>Mobile :</strong> <?php echo htmlspecialchars($result['contact'] ?? '', ENT_QUOTES, 'UTF-8'); ?><br>
         </td>
         <td colspan="4">
      ...
      <tr>
         <td colspan="3">
            BILLTO<br>
            <strong><?php echo htmlspecialchars($cust['cust_name'] ?? '', ENT_QUOTES, 'UTF-8'); ?></strong><br>
            Mobile: <?php echo htmlspecialchars($cust['cust_mob'] ?? '', ENT_QUOTES, 'UTF-8'); ?><br>
            Email: <?php echo htmlspecialchars($cust['cust_email'] ?? '', ENT_QUOTES, 'UTF-8'); ?><br>
         </td>
         <td colspan="4">
            <strong>SHIP TO <br><?php echo htmlspecialchars($cust['cust_name'] ?? '', ENT_QUOTES, 'UTF-8'); ?></strong>
         </td>
      </tr>
      <?php
      ...
      if (count($res2) > 0) {
         ...
         <tr>
            ...
            <td class="bg">-</td>
            <td class="bg"><?php echo $web['currency_symbol'];
            echo number_format1(($fstot + $ftax), 2); ?></td>
         </tr>
      </table>
      <?php
      foreach ($res2 as $row2) {
            ...
            <tbody>
               <tr>
                  ...
                  <td style="text-align:end">
                     <?php echo $web['currency_symbol'];
                     echo number_format1(($row2['quantity'] * $row1['unit_price']), 2); ?>
                  </td>
                  <?php $product = $row1['gst'];
                  $productArray = explode(',', $product);
                  foreach ($productArray as $pro_med) {
                  ...
                  ?>
                  <td style="text-align:end"><?php echo $web['currency_symbol'];
                  echo number_format1($ftaxtot, 2); ?></td>
               </tr>
               <tr class="total">
                  ...
                  <td style="text-align:end">
                     <?php echo $web['currency_symbol'];
                     echo number_format1($ftaxtot + ($row2['quantity'] * $row1['unit_price']), 2); ?>
                  </td>
               </tr>
            </tbody>
         </table>
   ...
   <table>
      ...
      <tr>
         ...
         <td class="qr-code" style="text-align:center">
            <p><img src="../assets/uploadImage/Logo/<?php echo $web['sign']; ?>" alt="Signature" width="80px"
                  height="80px"></p>
