                    ...
                    <div class="card-body">
                        <form class="form-horizontal" method="POST" enctype="multipart/form-data">
                            <div class="form-group row">
                                <label class="col-12 col-sm-3 col-form-label text-sm-right">New Password<span
                            ...
                            <div class="form-group row">
                                <label class="col-12 col-sm-3 col-form-label text-sm-right">Confirm Password<span
                                        class="text-danger">*</span></label>
                                <div class="col-12 col-sm-8 col-lg-6">
                            ...
                            <div class="form-group row text-center">
                                <div class="col col-sm-10 col-lg-9 offset-sm-1 offset-lg-0">
                                    ...
                                    <button type="submit" class="btn btn-space btn-primary " type="submit"
