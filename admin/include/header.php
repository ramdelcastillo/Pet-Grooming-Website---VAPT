                    ...
                    <ul class="navbar-nav ml-auto navbar-right-top">
                        ...
                        <li class="pt-3">
                            <div class="nav-user-info title3 info-user">
                                ...
                                <span class="status"></span><span
                                    class="ml-2"><?php if ($result['admin_user'] != '1') { ?><?= $result1['name']; ?><?php } ?></span>
                            </div>
                        </li>
                        <li class="nav-item dropdown nav-user">
                            ...
                            <div class="dropdown-menu dropdown-menu-right nav-user-dropdown"
                                ...
                                <a class="dropdown-item" href="change_pass.php"><i class="ti ti-key "></i> Change
                                    Password</a>
                                <div class="p-1">
                                    <a class="dropdown-item bg-orange text-white text-center" href="../logout.php"><i
